...
public class courseframe extends javax.swing.JFrame {
    ...
    public courseframe() {
        ...
        dm.addColumn("Course name");
          ...
          Statement st=db.setStatement();
           ...
           while(rs.next())
           {
               dm.addRow(new Object[]{rs.getString("course_id"),rs.getString("course_name")});
           }
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        pro.editucorseframe(id);
       this.dispose();
         }
         else
         {
              JOptionPane.showMessageDialog(null, "please select course", "failed", JOptionPane.ERROR_MESSAGE);
         }
